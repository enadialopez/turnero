    ...
    companion object {
        fun desdeModelo(turno: Turno) =
            TurnoDTO(
                ...
                hospital = HospitalDTO(turno.hospital!!.id, turno.hospital!!.nombre, turno.hospital!!.municipio, turno.hospital!!.direccion, turno.hospital!!.especialidades.map { especialidad -> especialidad.toString().toLowerCase()}
